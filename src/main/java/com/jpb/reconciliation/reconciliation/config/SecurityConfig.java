    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
             ...
             // KalInfotech Login/Register APIs
                ...
                // Super User APIs
                .requestMatchers(new AntPathRequestMatcher("/api/super-user/**")).permitAll()

                // Password APIs
                .requestMatchers(new AntPathRequestMatcher("/api/v1/user/reset-password")).permitAll()
                .requestMatchers(new AntPathRequestMatcher("/api/v1/user/set-password")).permitAll()
