...
public class ReconTemplateDetailsMapper {
    ...
    private ReconTemplateDetailsMapper() {}
    ...
    public static ReconFileTmpltMast mapTemplateDtoToFileTmpltMast(TemplateFieldDto request,
                                                                    ReconFileTmpltMast entity) {
    ...
    public static List<ReconTemplatesDetailsDTO> toDTOList(List<ReconFileTmpltMast> entities) {
        if (entities == null || entities.isEmpty()) return Collections.emptyList();
        List<ReconTemplatesDetailsDTO> result = new ArrayList<>();
    ...
    public static ReconTemplatesDetailsDTO toDTO(ReconFileTmpltMast entity) {
        if (entity == null) return null;

        ReconTemplatesDetailsDTO dto = ReconTemplatesDetailsDTO.builder()
        ...
        if (fieldSet != null && !fieldSet.isEmpty()) {
            List<ReconTemplatesDetailsDTO.FieldDefinitionDTO> fieldDtos = new ArrayList<>();
            fieldSet.stream()
    ...
    private static ReconTemplatesDetailsDTO.FieldDefinitionDTO toFieldDTO(ReconTmpltFieldDtls f) {
        return ReconTemplatesDetailsDTO.FieldDefinitionDTO.builder()
