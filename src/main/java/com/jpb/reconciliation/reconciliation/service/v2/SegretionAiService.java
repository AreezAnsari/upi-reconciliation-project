...
@Service
public class SegretionAiService {
	@Autowired
	private SimpleJdbcCall simpleJdbcCall;

	private final JdbcTemplate jdbcTemplate;

	public SegretionAiService(DataSource dataSource) {
	...
	public Boolean startSegretion(ReconBatchProcessEntity reconProcessManager,
			Optional<ReconTmpltFieldDtls> reconTemplateFileDetails) {
		String segretionMsg = null;
		Long templateId = reconTemplateFileDetails.get().getTemplate().getTemplateId();
		logger.info(
