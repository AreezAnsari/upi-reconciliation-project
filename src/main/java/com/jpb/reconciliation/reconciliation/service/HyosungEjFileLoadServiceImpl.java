...
public class HyosungEjFileLoadServiceImpl implements HyosungEjFileLoadService {
    ...
    public EjLoadResult loadFile(Path file) {
        ...
        HyosungEjTransactionRepository repo   = new HyosungEjTransactionRepository(dataSource);
    ...
    // Private helpers
    // -------------------------------------------------------------------------
    private int flush(List<EjTransaction> batch, HyosungEjTransactionRepository repo) {
