...
public class NTSLSettlementService {
	...
	public Boolean ntslSettlementProcess(ReconFileDetailsMaster reconFileDetails) {
		...
		if (reconFileDetails.getReconTemplateDetails().getReconStageTabName()
				.equalsIgnoreCase("REC_AEPS_AEA_STAGE_T")) {
			if (reconFileDetails.getReconTemplateDetails().getReconStageTabName().isEmpty()) {
				...
				String sqlQuery1 = "MERGE INTO npci_summary_tbl tgt\r\n" + "USING (\r\n" + "    SELECT\r\n"
						...
						+ "    FROM ";
				String inputTable = reconFileDetails.getReconTemplateDetails().getReconStageTabName();
		...
		} else if (reconFileDetails.getReconTemplateDetails().getReconStageTabName()
			...
			if (reconFileDetails.getReconTemplateDetails().getReconStageTabName().isEmpty()) {
				...
				String sqlISSQuery1 = "MERGE INTO npci_summary_tbl tgt\r\n" + "USING (\r\n" + "SELECT\r\n"
						...
						+ "FROM ";
				String inputIssTable = reconFileDetails.getReconTemplateDetails().getReconStageTabName();
			...
			String inputNtslTable = reconFileDetails.getReconTemplateDetails().getReconStageTabName();
			...
			String sqlImpsQuery2 = reconFileDetails.getReconTemplateDetails().getReconStageTabName();
			...
			String sqlImpsNTSLQuery2 = reconFileDetails.getReconTemplateDetails().getReconStageTabName();
			...
			String sqlUpiNtslQuery1 = "MERGE INTO npci_summary_tbl tgt\r\n"
					...
					+ "FROM " ;
			String sqlUpiNtslQuery2 = reconFileDetails.getReconTemplateDetails().getReconStageTabName();
			...
			String sqlUpiOtherFilesQuery1 = "MERGE INTO npci_summary_tbl tgt\r\n"
					...
					+ "            END) AS query_amount\r\n"
					+ "    FROM ";
			String sqlUpiOtherFilesQuery2 = reconFileDetails.getReconTemplateDetails().getReconStageTabName();
